...
CREATE UNIQUE INDEX IF NOT EXISTS uk_xg_plate_stock ON xuangutong_theme_plate (data_date, plate_id, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_dc_plate_stock ON dongcai_theme_plate (data_date, plate_id, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_wy_subject_stock ON wuyang_theme_subject (data_date, subject_name, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_ths_hot_list_day ON ths_hot_list_day (data_date, stock_type, rank_type, list_type, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_dc_hot_list_day ON dc_hot_list_day (data_date, list_type, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_cls_hot_list_day ON cls_hot_list_day (data_date, list_type, stock_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_market_daily_stat ON market_daily_stat (data_date);
