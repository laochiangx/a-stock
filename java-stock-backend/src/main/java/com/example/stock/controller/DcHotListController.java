...
@RestController
@RequestMapping("/api/dc-hot-list")
@CrossOrigin(origins = "*")
public class DcHotListController {

    @Autowired
    private DcHotListService dcHotListService;
    ...
    public Map<String, Object> ensureDayTable() {
        ...
        result.put("existsBefore", tableExists("dc_hot_list_day"));
        ...
        try {
            ...
            jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_dc_hot_list_day_date ON dc_hot_list_day (data_date)");
            jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_dc_hot_list_day_order ON dc_hot_list_day (data_date, order_num)");
        ...
        result.put("existsAfter", tableExists("dc_hot_list_day"));
        return result;
    }
    ...
    public Map<String, Object> syncDay(
        ...
        return dcHotListService.syncDayHotList(date, force, listType);
    }
    ...
    public Map<String, Object> listDay(
            @RequestParam(required = false) String date,
            @RequestParam(required = false) String listType) {
        return dcHotListService.listDayHotList(date, listType);
    }
