# a-stock : 基于大语言模型的AI赋能股票分析工具
## ![a-stock](./build/appicon.png)

天梯 · 通往成功的路
## 未曾清贫难成人，不经打击老天真。自古英雄出炼狱，从来富贵入凡尘。醉生梦死谁成器，破马长枪定乾坤。

天梯——AI 赋能的股票分析工具，助你一步步走向成功。

大盘竞价：今日竞价与历史竞价同屏，封单、连板一目了然，开盘前先人一步。
连板天梯：东财连板数据，多日连板股、红框紫框高亮，强势股一目了然。
题材板块：最强题材、段线侠实时数据，热点题材不遗漏。
龙图腾：题材龙头、情绪周期，龙头战法更清晰。
AI 复盘 / AI 诊股：接入 DeepSeek、OpenAI、火山方舟、阿里百炼等，一键 AI 分析，把复杂数据变成可执行思路。
自选股实时监控：A 股、港股、美股，涨跌、资金、新闻一屏掌握。
资金流向：个股、行业、主力/散户净流入，资金动向更直观。
龙虎榜、研报、公告：机构动向、研报、公告集中展示，信息更集中。
天梯，不是捷径，而是系统化的进阶路径。从数据到决策，从复盘到执行，每一步都更稳、更清晰。投资路上，天梯陪你一起向上攀登。

### 📈 交流群

- QQ交流群：[点击链接加入群聊【a-stock技术交流群】：1079549426](https://qm.qq.com/q/1079549426)

###  ✨ 简介
- 本项目基于Wails和NaiveUI开发，结合AI大模型构建的股票分析工具。
- 本项目基于开源项目 [go-stock](https://github.com/ArvinLovegood/go-stock) 改写而来，原本是go语言所写，改成java了。
...
### 📦 立即体验
- 下载地址（Gitee Releases）：[https://github.com/laochiangx/a-stock/releases/download/](https://github.com/laochiangx/a-stock/releases/download/1.0.2/astock-1.0.2-.exe)
