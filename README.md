...
- 本项目基于开源项目 [go-stock](https://github.com/ArvinLovegood/go-stock) 改写而来。
...
### 📦 立即体验
- 下载地址（Gitee Releases）：[https://gitee.com/gengyunzhongyue/a-stocks_all/releases](https://github.com/laochiangx/a-stock/releases/download/1.0.2/astock-1.0.2-.exe)
